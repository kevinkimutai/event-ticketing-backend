...
func (s *PDFService) GenerateTicket(attendee queries.GetAttendeeByUserIDRow, tickets []queries.GetTicketsByOrderIDRow) (string, error) {
	// Create a new PDF
	...
	filePath := filepath.Join(outputDir, fmt.Sprintf("%s.pdf", ticketName))
	...
	return fmt.Sprintf("%s.pdf", ticketName), err
}
